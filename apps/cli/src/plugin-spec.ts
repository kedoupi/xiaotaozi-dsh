...
export const DEFAULT_PLUGINS = [
  { name: "dsh-xtz-ui", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/xtz-ui" },
  { name: "dsh-sidebar", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/sidebar" },
  { name: "dsh-providers", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/providers" },
  { name: "dsh-im", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/im" },
  { name: "dsh-market", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/market" },
  { name: "dsh-wecom-office", spec: "github:kedoupi/xiaotaozi-dsh#v0.2.3&path:plugins/wecom-office" },
] as const;
