...
/** Current ceiling after FORGE-021 (delivery receipts, token bot controller, and connection supervisor). It may go down, never up. */
export const IM_TS_NOCHECK_MAX = 176;
