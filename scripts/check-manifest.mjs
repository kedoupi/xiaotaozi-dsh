...
/** Current ceiling after FORGE-022 (token bot RPC, token production controller, and Feishu connection supervisor). It may go down, never up. */
export const IM_TS_NOCHECK_MAX = 173;
