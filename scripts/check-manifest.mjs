...
/** Current ceiling after FORGE-017 (bot-instruction RPC, agent-preset RPC, and agent-preset helper). It may go down, never up. */
export const IM_TS_NOCHECK_MAX = 188;
