...
/** Current ceiling after FORGE-028 (workspace session, Office host production, and Office host RPC). It may go down, never up. */
export const IM_TS_NOCHECK_MAX = 155;
