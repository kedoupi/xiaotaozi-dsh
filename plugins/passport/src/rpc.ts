...
export const PASSPORT_CHANNEL = "/passport-auth";
...
export function registerPassportRpc(ctx: Context, controller: AuthController, enabled: readonly ProviderId[]): void {
