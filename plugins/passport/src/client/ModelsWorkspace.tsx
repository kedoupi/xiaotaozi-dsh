                  ...
                  <div className="dshM-auth">
                    ...
                    {currentSub.login === "oauth" ? (
                      <details className="dshM-manual">
                        ...
                        >
                          <label className="dshM-blockTitle" htmlFor={`pp-manual-${currentSub.id}`}>{t("manualLabel")}</label>
                          <input id={`pp-manual-${currentSub.id}`} className="dshM-input is-mono" value={manual} onChange={(event) => setManual(event.target.value)} placeholder={t("manualPlaceholder")} autoComplete="off" />
