...
import { createBotWorkspaceScope } from '../../../src/channels/shared/bot-workspace-store.ts';
import { HarnessClient } from '../../../src/channels/shared/harness-client.ts';
import { WORKSPACE_SESSION_STALE } from '../../../src/channels/shared/workspace-session.ts';
