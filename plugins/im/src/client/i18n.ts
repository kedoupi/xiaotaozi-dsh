...
const EN = Object.freeze({
  ...
  '工作区是项目目录，会话是一条聊天记录。一个目录里可以有很多条会话；一个聊天窗口当前只绑其中一条。机器人只能跟进自己工作区里的会话。': 'A workspace is a project folder; a session is one chat history. One folder can hold many sessions; one IM chat is bound to only one of them at a time. A bot can only follow sessions in its own workspace.',
  ...
  '正在更新 IM 跟进状态…': 'Updating IM follow-up…',
  '当前选中的 IM 会跟进这个会话，可换成其他 IM。': 'The selected IM follows this session. You can switch to another IM.',
  '只能选择工作区与这条会话相同的机器人。': 'Only bots whose workspace matches this session can follow it.',
  '只显示当前工作区里的机器人，勾选一个即可。': 'Only bots in this workspace are shown. Check one to follow.',
  '当前工作区没有可跟进的 IM 机器人。先打开侧栏的 IM 机器人，把机器人的工作区切到这个目录。': 'No IM bot in this workspace can follow this session. Open IM bots in the sidebar and switch a bot to this folder first.',
  '跟进这个会话': 'Follow this session',
  '不在这个工作区': 'Not in this workspace',
  '找不到这个会话的工作区': 'This session has no workspace',
  '未设置工作区': 'No workspace set',
  '这个机器人只能跟进自己工作区里的会话。': 'This bot can only follow sessions in its own workspace.',
  ...
  '不跟进': 'Stop following',
  '无法读取 IM 跟进。': 'Could not load IM follow-up.',
