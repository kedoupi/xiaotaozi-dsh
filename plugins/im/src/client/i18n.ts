...
const EN = Object.freeze({
  ...
  '工作区是项目目录，会话是一条聊天记录。一个目录里可以有很多条会话；一个聊天窗口当前只绑其中一条。机器人只能在 IM 中继续自己工作区里的会话。': 'A workspace is a project folder; a session is one chat history. One folder can hold many sessions; one IM chat is bound to only one of them at a time. A bot can only continue sessions from its own workspace in IM.',
  '绑定后请用卡片上的「选择目录」指定工作区，不要默认用到仓库根目录。发 /new 会开新会话，旧记录仍留在该目录。': 'After binding, use Choose folder on the card to set the workspace. Do not leave it on the repo root. /new starts a new session; old ones stay in the folder.',
  '常用命令': 'Commands',
  '解开当前聊天，下一条消息开一条新会话': 'Unbind this chat; the next message starts a new session',
  '列出当前工作区里的会话 ID 和标题': 'List session IDs and titles in the current workspace',
  '把当前聊天接到已有会话': 'Bind this chat to an existing session',
  '把当前聊天接到当前工作区里的已有会话': 'Bind this chat to an existing session in the current workspace',
  '切换这个机器人的工作区': "Switch this bot's workspace",
  ...
  '当前工作区没有可以继续此会话的 IM 机器人。先打开侧栏的 IM 机器人，把机器人的工作区切到这个目录。': 'No IM bot in this workspace can continue this session. Open IM bots in the sidebar and switch a bot to this folder first.',
  '不在这个工作区': 'Not in this workspace',
  '找不到这个会话的工作区': 'This session has no workspace',
  '未设置工作区': 'No workspace set',
  '这个机器人只能在 IM 中继续自己工作区里的会话。': 'This bot can only continue sessions from its own workspace in IM.',
  ...
  '办公服务连接失败，办公能力暂不可用。': 'Office service connection failed. Office is temporarily unavailable.',
  ...
  'CLI 与配置详情': 'CLI and config details',
  'CLI 版本': 'CLI version',
  '恢复授权后才能调整写权限。': 'Restore authorization before changing write permission.',
  '正在处理另一项办公操作，完成后可修改。': 'Another office action is in progress. Try again when it finishes.',
  '正在更新办公设置…': 'Updating office settings…',
  '重新检查': 'Recheck',
