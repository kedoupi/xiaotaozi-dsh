...
const EN = Object.freeze({
  ...
  '工作区是项目目录，会话是一条聊天记录。一个目录里可以有很多条会话；一个聊天窗口当前只绑其中一条。': 'A workspace is a project folder; a session is one chat history. One folder can hold many sessions; one IM chat is bound to only one of them at a time.',
