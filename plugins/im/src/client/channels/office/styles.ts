...
.dof-status[data-connected="true"] .dof-dot { background: var(--dsw-alias-state-success-primary, #78A317); box-shadow: 0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-success-primary, #78A317) 14%, transparent); }
