...
.bxf-button {
  ...
  cursor: pointer;
  transition: background-color 160ms var(--ds-ease-in-out, ease), border-color 160ms var(--ds-ease-in-out, ease), color 160ms var(--ds-ease-in-out, ease);
}
...
.bxf-brandMark {
  ...
  box-shadow: var(--dsw-shadow-lv2, 0 12px 28px rgb(31 35 41 / 14%));
}
...
.bxf-progress > span { display: block; width: var(--bxf-progress, 100%); height: 100%; border-radius: inherit; background: var(--bxf-brand-ink); transition: width 160ms linear; }
...
.bxf-orbitCore { width: 50px; height: 50px; display: grid; place-items: center; border-radius: 16px; color: var(--bxf-brand-ink); background: var(--dsw-alias-state-business-tertiary, color-mix(in srgb, var(--bxf-brand-ink) 9%, transparent)); }
...
.bxf-avatar { flex: none; width: 48px; height: 48px; display: grid; place-items: center; overflow: hidden; border: 1px solid var(--dsw-alias-border-l2, #e5e6eb); border-radius: 12px; background: var(--dsw-alias-bg-layer-1, #fff); box-shadow: var(--dsw-shadow-lv1, 0 1px 2px rgb(31 35 41 / 5%)); }
...
.bxf-healthPill { flex: none; display: inline-flex; align-items: center; gap: 7px; min-height: 28px; border-radius: 999px; padding: 4px 10px; color: var(--bxf-success-ink); background: color-mix(in srgb, var(--bxf-success) 10%, transparent); font-size: 12px; font-weight: 600; line-height: 18px; }
...
.bxf-metric { min-width: 0; border: 1px solid var(--dsw-alias-border-l2, #dee0e3); border-radius: 8px; padding: 12px 13px; background: var(--dsw-alias-bg-module-platform, #f7f8fa); }
...
.bxf-errorIcon { width: 44px; height: 44px; display: grid; place-items: center; border-radius: 12px; color: var(--bxf-error); background: color-mix(in srgb, var(--bxf-error) 9%, transparent); }
...
.bxf-responseModeSelect { min-width: 0; width: 100%; grid-column: 1 / -1; grid-row: 2; height: 36px; padding: 0 30px 0 9px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; color: var(--dsw-alias-label-primary, #1f2329); background-color: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 12px; cursor: pointer; }
