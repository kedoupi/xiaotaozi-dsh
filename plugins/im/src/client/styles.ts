...
.dim-otherChannels { flex: 1 1 100%; min-width: 0; }
.dim-otherChannels > summary { list-style: none; display: flex; align-items: center; gap: 8px; min-height: 32px; padding: 2px 2px 4px; color: var(--dsw-alias-label-secondary, #646a73); font-size: 12px; font-weight: 600; cursor: pointer; }
.dim-otherChannels > summary::-webkit-details-marker { display: none; }
.dim-otherChannelList { display: flex; flex-wrap: wrap; gap: 6px; padding: 0 0 2px; }
...
/* Channel logo container (spec §3.2): squircle + glyph at 60%; channels only supply bg/border. */
.dim-logo { width: 22px; height: 22px; display: grid; place-items: center; border-radius: var(--xtz-radius-s, 8px); box-shadow: none; }
.dim-logo svg { display: block; width: 13px; height: 13px; }
...
.dim-panel .dim-usageGuide > summary::after { content: ""; width: 7px; height: 7px; flex: none; border-right: 1.5px solid currentColor; border-bottom: 1.5px solid currentColor; transform: rotate(45deg); transition: transform var(--xtz-dur-fast, 120ms) ease; }
...
.dim-panel .dim-emptyBrand { width: 110px; height: 110px; display: grid; place-items: center; justify-self: center; border-radius: 26px; }
...
.dim-panel .dim-stateDot[data-tone="success"] { background: var(--dsw-alias-state-success-primary, #78A317); }
...
.dim-panel .dim-qrExpired { position: absolute; inset: 0; z-index: 2; display: grid; place-items: center; padding: 20px; color: var(--dsw-static-neutral-bluish-1000, #0f1115); background: rgb(255 255 255 / 92%); font-size: 15px; line-height: 1.6; font-weight: 650; text-align: center; white-space: pre-line; }
...
.dim-panel .dim-progress span { display: block; width: var(--bxf-progress, var(--dxw-progress, var(--ddt-progress, 0%))); height: 100%; border-radius: inherit; background: var(--dim-brand-ink); transition: width var(--xtz-dur-fast, 120ms) linear; }
...
.dim-panel .dim-preset { min-width: 0; margin-top: 6px; padding: 2px 0; border-top: 1px solid var(--dsw-alias-border-l1, #eef0f3); }
.dim-panel .dim-presetSummary { position: relative; min-width: 0; min-height: 32px; display: flex; align-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: 12px; line-height: normal; list-style: none; cursor: pointer; }
.dim-panel .dim-presetSummary::-webkit-details-marker { display: none; }
.dim-panel .dim-presetSummary:focus-visible { outline: 2px solid var(--dim-focus); outline-offset: 2px; }
...
.dim-panel .dim-presetCurrent { min-width: 0; margin-left: auto; overflow: hidden; color: var(--dsw-alias-label-primary, #1f2329); font-weight: 600; text-overflow: ellipsis; white-space: nowrap; }
.dim-panel .dim-presetBody { display: grid; gap: 6px; padding: 4px 0 8px; }
.dim-panel .dim-presetSelect { min-width: 0; max-width: 100%; height: 36px; padding: 0 8px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 12px; }
...
.dim-panel .dim-presetError { margin: 0; color: var(--dim-error-ink); font-size: 12px; line-height: 1.4; }
.dim-panel .dim-instruction { margin-top: 6px; padding: 2px 0; border-top: 1px solid var(--dsw-alias-border-l1, #eef0f3); }
...
.dim-panel .dim-cardFooterLayout > .dim-cardActions { align-self: stretch; width: 100%; justify-content: space-between; margin: 0; }
...
.dim-panel .dim-cardActions { flex: none; display: flex; align-items: center; flex-wrap: wrap; justify-content: space-between; gap: 8px; margin: 0 0 0 auto; }
...
.dim-panel .dim-cardActions .dim-cardAction[data-kind="danger"] { margin-left: auto; color: var(--dim-error-ink); }
...
.dim-panel .dim-botAvatar { flex: none; width: 38px; height: 38px; display: grid; place-items: center; overflow: hidden; border-radius: var(--xtz-radius-m, 12px); box-shadow: none; }
.dim-panel .dim-botAvatar .dim-logo { width: 38px; height: 38px; border-radius: var(--xtz-radius-m, 12px); }
/* 38px container × 60% ≈ 23px glyph (spec §3.2) */
.dim-panel .dim-botAvatar svg { width: 23px; height: 23px; }
...
.dim-panel .dim-botCard .dim-healthDot[data-tone="success"] { background: var(--dsw-alias-state-success-primary, #78A317); box-shadow: 0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-success-primary, #78A317) 14%, transparent); }
