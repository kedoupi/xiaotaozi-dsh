 ...
 * (editor / git / subagent / sidechat / terminal / diff) through
 ...
 * and mints `terminal:<uuid>` ids through `createTab`. The editor IS the
 * files window (the old standalone explorer merged into it).
 */
