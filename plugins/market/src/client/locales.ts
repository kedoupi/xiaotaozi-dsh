export const zh = {
  ...
  removeConfirmDescription: "将从当前 Web profile 移除。你可以稍后重新安装。",
  removeCancel: "保留",
  removeConfirm: "确认移除",
  queued: "已排队",
...
export const en: Record<MarketKey, string> = {
  ...
  removeConfirmDescription: "will be removed from the current web profile. You can install it again later.",
  removeCancel: "Keep",
