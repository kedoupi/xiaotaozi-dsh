export const zh = {
  nav: "插件中心",
  subtitle: "管你电脑里的工作伙伴：内置功能在这边，精选插件在发现页。",
  ...
  runHint: "装好后，在对话里用它。这里不负责启动或关掉插件。",
  capabilityXiaotaozi: "小桃子功能",
  capabilityWorkbench: "侧边工作台",
  capabilityModels: "模型",
  capabilityIm: "IM 机器人",
  summaryXiaotaozi: "归档会话和 Git 图谱。",
  ...
  removeConfirmDescription: "将从当前这套配置里拿掉。可以再装回来；凭证和数据不保证被删除。",
  removeCancel: "保留",
  removeConfirm: "确认移除",
  queued: "已排队",
...
export const en: Record<MarketKey, string> = {
  nav: "Plugin Center",
  subtitle: "Your in-computer work partner: built-in features here, curated plugins under Discover.",
  ...
  runHint: "After install, use it in conversation. This page does not start or stop plugins.",
  capabilityXiaotaozi: "Xiaotaozi features",
  capabilityWorkbench: "Side workbench",
  capabilityModels: "Models",
  capabilityIm: "IM bots",
  summaryXiaotaozi: "Archived chats and the Git graph.",
  ...
  removeConfirmDescription: "It will be removed from this configuration. You can install it again later. Credentials and data may remain.",
  removeCancel: "Keep",
  ...
  installForTerminal: "For terminal users",
