...
export function mockEntriesFor(source: MarketSource): CatalogEntry[] {
  ...
  return [
    official({ id: "hello", name: "小桃子工作台", version: "0.2.1", summary: "品牌界面、归档、右侧工作台与设置页。", tags: ["界面", "官方"], kind: "plugin", installed: true }),
    official({ id: "providers", name: "模型服务", version: "0.1.0", summary: "DeepSeek 与兼容模型提供方配置。", tags: ["模型", "官方"], kind: "plugin", installed: true }),
    official({ id: "memory", name: "记忆", version: "0.1.0", summary: "跨会话记忆（Noema 引擎）。", tags: ["记忆", "官方"], kind: "plugin", installed: true }),
    official({ id: "im", name: "消息通道", version: "0.1.0", summary: "微信、企业微信、飞书、钉钉、QQ 等通道接入。", tags: ["消息", "官方"], kind: "plugin", installed: true }),
