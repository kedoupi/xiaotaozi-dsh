...
- Plugin copy and flows: `plugins/providers/src/client/locales.ts`, `ModelsWorkspace.tsx`
- Subscription catalog: `plugins/providers/src/catalog.ts`
- README: `plugins/providers/README.md` (English), `plugins/providers/README.zh.md` (Chinese)
