...
**FR-15 中英语文案**  
设置 / 归档 / Git 图谱走 Host locale。品牌名固定中文「小桃子DSH」。
...
**NFR-03 体积限制**  
设置 POST 16 KiB；归档 JSON 64 KiB。超限 413。
...
**NFR-06 可观测**  
无遥测。错误以 HTTP JSON `{ ok:false, error }` 或客户端设置页错误文案返回。
...
9. `pnpm --filter dsh-xtz-ui test` 通过。
